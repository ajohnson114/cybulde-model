gcloud compute instances create-with-container etcd-server \
    --project=ml-apps-409905 \
    --zone=us-east4-a \
    --machine-type=n1-standard-1 \
    --network-interface=subnet=default,no-address \
    --maintenance-policy=MIGRATE \
    --provisioning-model=STANDARD \
    --service-account=886469202669-compute@developer.gserviceaccount.com \
    ...
    --labels=goog-ec-src=vm_add-gcloud,container-vm=cos-stable-109-17800-66-65